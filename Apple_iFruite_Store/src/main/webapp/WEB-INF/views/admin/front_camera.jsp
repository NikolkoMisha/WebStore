		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbario">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a id="text_color" href="/admin/type/front_camera">Фронтальна камера</a><span
						class="sr-only">(current)</span></li>
...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/type/front_camera" method="POST" modelAttribute="frontcamera">
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label" style="color:#fff">Фронтальна камера</label>
    					<div class="col-sm-10">
	...
	<div class="row">
			...
			<c:forEach items="${frontcameras}" var="frontcamera">
				<div class="row">
					<div class="col-md-4 col-xs-4"><h4 class="adminka">${frontcamera.name}</h4></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/type/front_camera/update/${frontcamera.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/type/front_camera/delete/${frontcamera.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
