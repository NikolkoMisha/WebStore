		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbario">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a id="text_color" href="/admin/type/diagonal">Діагональ екрану</a><span
						class="sr-only">(current)</span></li>
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/type/diagonal" method="POST" modelAttribute="diagonal">
					...
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label" style="color:#fff">Діагональ</label>
    					<div class="col-sm-10">
		...
		<div class="row">
			<div class="col-md-4 col-xs-4"><h3 class="adminka">Діагональ</h3></div>
			<div class="col-md-4 col-xs-4"><h3 class="adminka">Update</h3></div>
			<div class="col-md-4 col-xs-4"><h3 class="adminka">Delete</h3></div>
		</div>
			<c:forEach items="${diagonals}" var="diagonal">
				<div class="row">
					<div class="col-md-4 col-xs-4"><h4 class="adminka">${diagonal.name}</h4></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/type/diagonal/update/${diagonal.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/type/diagonal/delete/${diagonal.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
