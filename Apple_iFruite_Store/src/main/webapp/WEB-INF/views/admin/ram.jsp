		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbario">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a id="text_color" href="/admin/type/ram">Оперативна пам'ять</a><span
						class="sr-only">(current)</span></li>
...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/type/ram" method="POST" modelAttribute="ram">
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label" style="color:#fff">Оперативна пам'ять</label>
    					<div class="col-sm-10">
	...
	<div class="row">
			...
			<c:forEach items="${rams}" var="ram">
				<div class="row">
					<div class="col-md-4 col-xs-4"><h4 class="adminka">${ram.name}</h4></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/type/ram/update/${ram.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/type/ram/delete/${ram.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
