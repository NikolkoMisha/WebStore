		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbario">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a id="text_color" href="/admin/type/weight">Вага</a><span
						class="sr-only">(current)</span></li>
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/type/weight" method="POST" modelAttribute="weight">
					...
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label" style="color:#fff">Вага</label>
    					<div class="col-sm-10">
		...
		<div class="row">
			<div class="col-md-4 col-xs-4"><h3 class="adminka">Вага</h3></div>
			...
			<c:forEach items="${weights}" var="weight">
				<div class="row">
					<div class="col-md-4 col-xs-4"><h4 class="adminka">${weight.name}</h4></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/type/weight/update/${weight.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/type/weight/delete/${weight.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
