		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbario">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a id="text_color" href="/admin/type/operating_system">Операційна система</a><span
						class="sr-only">(current)</span></li>
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/type/operating_system" method="POST" modelAttribute="operating_system">
					...
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label" style="color:#fff">Операційна система</label>
    					<div class="col-sm-10">
		...
		<div class="row">
			<div class="col-md-4 col-xs-4"><h3 class="adminka">Операційна система</h3></div>
			<div class="col-md-4 col-xs-4"><h3 class="adminka">Update</h3></div>
			<div class="col-md-4 col-xs-4"><h3 class="adminka">Delete</h3></div>
		</div>
			<c:forEach items="${operating_systems}" var="operating_system">
				<div class="row">
					<div class="col-md-4 col-xs-4"><h4 class="adminka">${operating_system.name}</h4></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/type/operating_system/update/${operating_system.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/type/operating_system/delete/${operating_system.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
